...
public class FixGridLayout extends ViewGroup {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        int columnsX = (r - l) / (cellWidth == 0 ? 1 : cellWidth);
        int columnsY = (b - t) / (cellHeight == 0 ? 1 : cellHeight);
        ...
        //计算控件间隔宽度
        int intervalX = ((r - l) - columnsX * cellWidth) / iX;
        //计算控件间隔高度
        int intervalY = ((b - t) - columnsY * cellHeight) / iY;

        Log.e(TAG, "onLayout: (r - l)=" + (r - l) + " columns=" + columnsX +
                " intervalX=" + intervalX + " (b - t)=" + (b - t) + " intervalY=" + intervalY);
        Log.e(TAG, "onLayout: cellWidth=" + cellWidth + " cellHeight=" + cellHeight);
        ...
        for (int j = 0; j < count; j++) {
            ...
            Log.e("FixGridLayout", "onLayout: l=" + left + " t=" + top + " r=" + left + w + " b=" + top + h);
            if (i >= (columnsX - 1)) {
                i = 0;
                x = 0;
                y += cellHeight + intervalY;
            } else {
                i++;
                x += cellWidth + intervalX;
